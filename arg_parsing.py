...
parser = argparse.ArgumentParser(
    ...
    epilog='NOTE: The first save takes place at <start_time> + <interval_time>. The last (partially finished) interval are excluded. An empty output file could mean that you specified the topics wrongly')
